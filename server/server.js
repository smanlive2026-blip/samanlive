...
// [COMMENT] AUTO SHOP TEMPLATE - public/shop-templates/auto/dashboard.html
...
// [COMMENT] ACHAR & AUTO SHOP TEMPLATE - public/shop-templates/achar-shop/ + auto/
...
// [COMMENT] FURNITURE SHOP TEMPLATE - public/shop-templates/furniture/dashboard.html (banner, product-library wala)
app.use('/api/shops/furniture', require('./routes/shops/furniture-route')); // 2. FURNITURE ALAG

// [COMMENT] GENERIC SHOP ROUTE - Baaki 50+ templates (bakery, kirana, medical, cloth etc) - public/shop-templates/*/
app.use('/api/shops', require('./routes/shopRoutes')); // 3. BAAKI SAB GENERIC

// [COMMENT] SPORTS & KIRANA TEMPLATE - public/shop-templates/sports/ + kirana/ - sabse zyada use
app.use('/api/shops/sports', require('./routes/shops/sports-route'));
app.use('/api/shops/kirana', require('./routes/shops/kirana-route'));

// [COMMENT] SHOP TOGGLE - public/shop-templates/common/shop-toggle.js - dukan khuli/band
...
// [COMMENT] SHOP TEMPLATES STATIC - public/shop-templates/achar-shop/, fruit/, bakery/ etc ke saare html/js
...
// ==================== MONGODB CONNECT ====================
// [COMMENT] MongoDB - Tera main DB, iske bina kuch nahi chalega
...
// [COMMENT] AUTH - login/signup
app.use('/api/auth', require('./routes/auth'));

// [COMMENT] ADMIN PANEL ROUTES - public/admin-panel/*.html
app.use('/api', require('./routes/adminRoutes'));

// [COMMENT] MANAGER ROUTES - Area manager ka kaam
app.use('/api/manager', require('./routes/managerRoutes'));

// [COMMENT] AREA ROUTES - areas.html, area-detail.html
app.use('/api', require('./routes/areaRoutes'));

// [COMMENT] MARKET / NEARBY SHOPS - local-market.html, nearby-shops.html ke liye
...
// ==================== AREA MANAGER ROUTE ====================
// [COMMENT] AREA MANAGER - area-manager.html - iske bina area manager band ho jata hai
...
// [COMMENT] SHOP DASHBOARD - /shop/:id/dashboard - Yaha se 70 templates me se sahi wala khulta hai
