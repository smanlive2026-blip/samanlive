...
router.post('/areas', async (req, res) => {
    try {
        ...
        // ========== AUTO MANAGER CREATE - FIXED VERSION ==========
        try {
            ...
            if (!existingManager) {
                ...
                const manager = new Manager({
                    ...
                    password: tempPassword, // <-- Required field add kiya
                    phone: '9999999999',
                    area: area.areaName, // <-- Required field add kiya
                    areaCode: area.areaCode,
                    ...
                    status: true
                    // city aur autoGenerated hata diya kyunki model me nahi hai
                });
